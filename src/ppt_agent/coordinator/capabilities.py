...
DOCUMENT_ANALYSIS = AgentCapability(
    ...
    tools=["read_input_files", "read_artifact", "write_artifact", "validate_output", "search_knowledge_base"],
    max_turns=8,
...
OUTLINE_GENERATION = AgentCapability(
    ...
    tools=["read_artifact", "write_artifact", "validate_output", "search_knowledge_base", "load_skill"],
    max_turns=10,
...
DESIGN_PLANNING = AgentCapability(
    ...
    tools=["read_artifact", "write_artifact", "validate_output", "load_skill"],
    max_turns=10,
